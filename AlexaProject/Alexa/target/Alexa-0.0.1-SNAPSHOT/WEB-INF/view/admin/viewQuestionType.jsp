			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="page-header">
						<h3 class="page-title">Question Type</h3>
					</div>
								...
								<div class="col-12">
									<div class="table-responsive">
										<table id="order-listing" class="table">
											...
											<tbody>
												<c:forEach items="${questionTypeList}" var="i" varStatus="j">
													<tr>
														<td>${j.count}</td>
														<td>${i.skillVO.skillName}</td>
														<td>${i.questionTypeName}</td>
														<td>${i.questionTypeDescription}</td>
														<td><a href="editQuestionType?id=${i.questionTypeId}"><i
																class="mdi mdi-pencil lead"></i> </a> <a
															href="deleteQuestionType?id=${i.questionTypeId}"><i
